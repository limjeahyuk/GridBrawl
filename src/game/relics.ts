...
> = {
  ...
  archer: {
    ...
    runEffect: { attackBonus: 9, poisonOnHit: 3, damageReduction: 6, maxHpBonus: 29, lifesteal: 3 },
    desc: '독니 화살통: 최대 체력 +29, 받는 피해 -6. 내 공격 피해 +9, 피해를 주면 체력 3 흡수 + 독 3.',
  },
  mage: {
    ...
    runEffect: { turnEnergy: 10, turnShield: 12, burnOnHit: 3, damageReduction: 5, maxHpBonus: 44 },
    desc: '혼백의 등불: 최대 체력 +44, 받는 피해 -5. 매 턴 기력 +10·보호막 +12, 피해를 주면 화상 3을 묻힌다.',
  },
}
