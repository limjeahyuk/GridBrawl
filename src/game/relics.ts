...
> = {
  warrior: {
    ...
    runEffect: { damageReduction: 8, regen: 3, thorns: 6, maxHpBonus: 8 },
    desc: '서약의 돌무덤: 최대 체력 +8, 받는 공격 피해 -8, 매 턴 체력 +3, 피격 시 6 반사.',
  },
  archer: {
    ...
    runEffect: { attackBonus: 9, poisonOnHit: 4, statusPowerPct: 25, damageReduction: 7, maxHpBonus: 44, lifesteal: 5 },
    desc: '독니 화살통: 최대 체력 +44, 받는 피해 -7. 내 공격 피해 +9, 피해를 주면 체력 5 흡수 + 독 4, 내 지속피해 위력 +25%.',
  },
  mage: {
    ...
    runEffect: { turnEnergy: 10, turnShield: 16, burnOnHit: 3, damageReduction: 6, maxHpBonus: 46 },
    desc: '혼백의 등불: 최대 체력 +46, 받는 피해 -6. 매 턴 기력 +10·보호막 +16, 피해를 주면 화상 3을 묻힌다.',
  },
}
